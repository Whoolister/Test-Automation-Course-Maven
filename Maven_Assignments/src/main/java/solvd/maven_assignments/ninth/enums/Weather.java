...
import solvd.maven_assignments.ninth.battle.Conditions;
...
public enum Weather {
    ...
    private final Conditions<Animal> condition;

    Weather(String description, String icon, Conditions<Animal> condition) {
