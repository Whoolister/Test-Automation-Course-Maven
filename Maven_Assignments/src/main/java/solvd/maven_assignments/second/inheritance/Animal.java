...
public abstract class Animal {
    ...
    protected void flex() {
        System.out.println("This being has acquired, through their evolutionary lineage, a special set of abilities to secure \n"
                + "it's long term survival on the grand tournament that is our biosphere. Shown here are some of their \n"
                + "unique traits, pivotal points in their evolution, leading their plans from here to extinction:");
        for (String element : specialTraits) {
