...
public class Reptile extends Vertebrate implements IEctothermy, IEndothermy {
    ...
    public Reptile() {
        super(Respiration.LUNGS,
                (new Random()).nextInt(2) < 1 ? Locomotion.QUADRUPEDAL : Locomotion.SLITHERING,
                Intelligence.SOME,
    ...
    public String toString() {
        return "Reptile [Name: " + this.name +
                " | Rank: " + this.rank +
                " | Respiration: " + this.respiration +
                " | Locomotion: " + this.locomotion + "| Intelligence: " + this.intelligence +
                " | Diet: " + this.diet +
